...
export default function Home() {
  return (
    <div>
      <Head>
        <title>Wear the code</title>
        <meta name="description" content="Code wear ki web site" />
        <link rel="icon" href="/favicon.ico" />
      </Head>
     
      <Image src="/home.jpg" alt="" srcSet="" height={744} width={1920} />
      <section className="text-gray-600 body-font">
  <div className="container px-5 py-24 mx-auto">
    <div className="flex flex-wrap w-full mb-20 flex-col items-center text-center">
      <h1 className="sm:text-3xl text-2xl font-medium title-font mb-2 text-gray-900">COde wear the code</h1>
